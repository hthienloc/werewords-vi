...
* **💾 Hoạt động Offline**: Lưu trữ dữ liệu cục bộ, không cần máy chủ hay đăng nhập.
...
1. `git clone https://github.com/hthienloc/werewords-vi.git`
2. `npm install`
3. `npm run dev`
...
Phát hành dưới giấy phép **GNU GPLv3**. Xem tệp `LICENSE` để biết thêm chi tiết.
