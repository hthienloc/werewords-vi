...
function reducer(state: AppState, action: Action): AppState {
  switch (action.type) {
    ...
    case 'ADD_WORD_PACK':
      return { ...state, wordPacks: [...state.wordPacks, action.payload] }
    ...
    case 'DELETE_WORD_PACK':
      return {
        ...state,
        wordPacks: state.wordPacks.filter((p) => p.id !== action.payload),
      }
      ...
      return {
        ...
        wordPacks: state.wordPacks.map((p) =>
          p.id === action.payload.packId
            ? {
                ...p,
                words: p.words.filter((w) => w.id !== action.payload.wordId),
              }
            : p
        ),
      }
